...
INSERT into TB_BATCH_JOB (BATCH_JOB_ID, BATCH_ID, JOB_SCHEDULE, IS_USAGE, IS_SINGLE_TRANSACTION, READER_BEAN_ID, READER_PROPERTIES, WORKER_BEAN_ID,
                          WORKER_PROPERTIES, WRITER_BEAN_ID, WRITER_PROPERTIES, START_DATETIME, END_DATETIME, EXECUTE_RESULT, ERROR_MESSAGE, REGIST_DATETIME, UPDATE_DATETIME)
